                ...
                <ol className="space-y-7">
                  {OWNS.map((row, i) => (
                    ...
                    >
                      ...
                      <div>
                        <p className="font-display font-light text-display-xs text-white leading-[1.3] tracking-[-0.005em] mb-1">
                          {row.item}
                        </p>
                        <p
                ...
                <ol className="space-y-7">
                  {DOESNT_OWN.map((row, i) => (
                    ...
                    >
                      ...
                      <div>
                        <p className="font-display font-light text-display-xs text-white/55 leading-[1.3] tracking-[-0.005em] line-through decoration-white/25 mb-1">
                          {row.item}
                        </p>
                        <p
